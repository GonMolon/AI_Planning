(define (problem redflix_problem)
  ...
  (:init
    ...
    (watched star_trek-1-1 somewhen) (watched star_trek-1-2 somewhen) (watched star_trek-1-3 somewhen) (watched star_trek-1-4 never)
    (watched star_trek-2-1 never) (watched star_trek-2-2 never) (watched star_trek-2-3 never)
    ...
    (watched star_wars-1 never) (watched star_wars-2 never) (watched star_wars-3 never) (watched star_wars-4 never) (watched star_wars-5 never)
    (watched star_wars-6 never) (watched star_wars-7 never)
